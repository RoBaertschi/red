...
/*
    ...
    Cmdline:
        sokol-shdc --input basic.glsl --output basic.glsl.odin --slang glsl430:hlsl5:metal_macos --format sokol_odin

    Overview:
    =========
    Shader program: 'basic':
        Get shader desc: basic_shader_desc(sg.query_backend())
        Vertex Shader: basic_vs
        Fragment Shader: basic_fs
        Attributes:
            ATTR_basic_position => 0
            ATTR_basic_color0 => 1
    Bindings:
        Uniform block 'basic_vs_params':
            Odin struct: Basic_Vs_Params
            Bind slot: UB_basic_vs_params => 0
*/
ATTR_basic_position :: 0
ATTR_basic_color0 :: 1
UB_basic_vs_params :: 0
Basic_Vs_Params :: struct #align(16) {
...
/*
    ...
    uniform vec4 basic_vs_params[4];
    ...
    void main()
    {
        gl_Position = mat4(basic_vs_params[0], basic_vs_params[1], basic_vs_params[2], basic_vs_params[3]) * vec4(position, 1.0);
        color = color0;
    }

*/
@(private="file")
basic_vs_source_glsl430 := [325]u8 {
    ...
    0x20,0x6d,0x61,0x74,0x34,0x28,0x62,0x61,0x73,0x69,0x63,0x5f,0x76,0x73,0x5f,0x70,
    0x61,0x72,0x61,0x6d,0x73,0x5b,0x30,0x5d,0x2c,0x20,0x62,0x61,0x73,0x69,0x63,0x5f,
    0x76,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,0x5b,0x31,0x5d,0x2c,0x20,0x62,0x61,
    0x73,0x69,0x63,0x5f,0x76,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,0x5b,0x32,0x5d,
    0x2c,0x20,0x62,0x61,0x73,0x69,0x63,0x5f,0x76,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,
...
*/
@(private="file")
basic_fs_source_glsl430 := [135]u8 {
...
/*
    cbuffer basic_vs_params : register(b0)
    {
...
*/
@(private="file")
basic_vs_source_hlsl5 := [770]u8 {
    0x63,0x62,0x75,0x66,0x66,0x65,0x72,0x20,0x62,0x61,0x73,0x69,0x63,0x5f,0x76,0x73,
    ...
    0x5f,0x31,0x39,0x5f,0x70,0x72,0x6f,0x6a,0x20,0x3a,0x20,0x70,0x61,0x63,0x6b,0x6f,
    ...
    0x29,0x2c,0x20,0x5f,0x31,0x39,0x5f,0x70,0x72,0x6f,0x6a,0x29,0x3b,0x0a,0x20,0x20,
...
/*
    ...
    vertex main0_out main0(main0_in in [[stage_in]], constant basic_vs_params& _19 [[buffer(0)]])
    {
        main0_out out = {};
...
*/
@(private="file")
basic_vs_source_metal_macos := [536]u8 {
    ...
    0x61,0x73,0x69,0x63,0x5f,0x76,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,0x0a,0x7b,
    ...
    0x62,0x61,0x73,0x69,0x63,0x5f,0x76,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,0x26,
...
*/
@(private="file")
basic_fs_source_metal_macos := [315]u8 {
    0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,0x20,0x3c,0x6d,0x65,0x74,0x61,0x6c,0x5f,
    0x73,0x74,0x64,0x6c,0x69,0x62,0x3e,0x0a,0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,
    0x20,0x3c,0x73,0x69,0x6d,0x64,0x2f,0x73,0x69,0x6d,0x64,0x2e,0x68,0x3e,0x0a,0x0a,
    0x75,0x73,0x69,0x6e,0x67,0x20,0x6e,0x61,0x6d,0x65,0x73,0x70,0x61,0x63,0x65,0x20,
...
basic_shader_desc :: proc (backend: sg.Backend) -> sg.Shader_Desc {
    ...
    case .GLCORE:
        desc.vertex_func.source = transmute(cstring)&basic_vs_source_glsl430
        desc.vertex_func.entry = "main"
        desc.fragment_func.source = transmute(cstring)&basic_fs_source_glsl430
        ...
        desc.uniform_blocks[0].glsl_uniforms[0].glsl_name = "basic_vs_params"
    case .D3D11:
        desc.vertex_func.source = transmute(cstring)&basic_vs_source_hlsl5
        desc.vertex_func.d3d11_target = "vs_5_0"
        desc.vertex_func.entry = "main"
        desc.fragment_func.source = transmute(cstring)&basic_fs_source_hlsl5
    ...
    case .METAL_MACOS:
        desc.vertex_func.source = transmute(cstring)&basic_vs_source_metal_macos
        desc.vertex_func.entry = "main0"
        desc.fragment_func.source = transmute(cstring)&basic_fs_source_metal_macos
